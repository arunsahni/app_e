...
module.exports.globals = {
  ...
  ****************************************************************************/
  ...
  //curr-date-time in miliseconds @access by :  sails.config.globals.gTimeStamp
  gTimeStamp: new Date().getTime(),

//for jwt
  tokenSecret: 'hakunamata',

  //expiry default time for token
  tokenExpiry: 3600, //in minutes

  //site url change here
  siteURL: 'http://192.155.246.146:1237',
  siteCommissionIndividual: 10, //%
  siteCommissionCompany: 6, //%
  processingFee: 0, //$
  ipnURL : 'http://192.155.246.146:1237/payment/ipn',
  ipnURLEscrowSuccess: 'http://192.155.246.146:1237/payment/escrowSuccess',
  ipnURLSubscriptionSuccess: '',
  escrowReleaseApi: 'http://192.155.246.146:1238/ejizzy/releaseEscrowPayment',
  fullRefundApi: 'http://192.155.246.146:1238/ejizzy/refundEscrowPay',
};